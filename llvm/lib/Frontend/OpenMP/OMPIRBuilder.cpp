...
void OpenMPIRBuilder::getKernelArgsVector(TargetKernelArgs &KernelArgs,
  ...
  Value *MayFallbackDynCGroupMemFlag = Builder.getInt64(KernelArgs.MayFallbackDynCGroupMem);
  MayFallbackDynCGroupMemFlag = Builder.CreateShl(MayFallbackDynCGroupMemFlag, 2);

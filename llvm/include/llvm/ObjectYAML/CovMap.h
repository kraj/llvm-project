...
/// Key is FilenamesRef.
using CovMapByRefTy = llvm::DenseMap<uint64_t, struct CovMapV7 *>;
...
LLVM_YAML_IS_SEQUENCE_VECTOR(llvm::coverage::yaml::CovMapV7)
LLVM_YAML_IS_SEQUENCE_VECTOR(llvm::coverage::yaml::CovFunV7)
...
LLVM_COVERAGE_YAML_ELEM_MAPPING(CovFunV7)
LLVM_COVERAGE_YAML_ELEM_MAPPING(CovMapV7)

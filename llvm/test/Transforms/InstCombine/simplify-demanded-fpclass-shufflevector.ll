...
; CHECK-SAME: i1 [[COND:%.*]], <4 x half> [[UNKNOWN:%.*]]) {
; CHECK-NEXT:    [[NAN:%.*]] = call <4 x half> @returns_nan()
; CHECK-NEXT:    [[TMP1:%.*]] = fadd <4 x half> [[NAN]], splat (half 0xH3C00)
; CHECK-NEXT:    [[EXP:%.*]] = shufflevector <4 x half> [[TMP1]], <4 x half> poison, <4 x i32> <i32 1, i32 2, i32 0, i32 3>
; CHECK-NEXT:    ret <4 x half> [[EXP]]
;
  %nan = call <4 x half> @returns_nan()
  %shuffle = shufflevector <4 x half> %nan, <4 x half> %unknown, <4 x i32> <i32 1, i32 2, i32 0, i32 3>
...
; CHECK-SAME: i1 [[COND:%.*]], <4 x half> [[UNKNOWN:%.*]]) {
; CHECK-NEXT:    [[NAN:%.*]] = call <4 x half> @returns_nan()
; CHECK-NEXT:    [[TMP1:%.*]] = call <4 x half> @llvm.exp.v4f16(<4 x half> [[UNKNOWN]])
; CHECK-NEXT:    [[EXP:%.*]] = shufflevector <4 x half> [[TMP1]], <4 x half> poison, <4 x i32> <i32 1, i32 2, i32 0, i32 3>
; CHECK-NEXT:    ret <4 x half> [[EXP]]
;
  %nan = call <4 x half> @returns_nan()
  %shuffle = shufflevector <4 x half> %unknown, <4 x half> %nan, <4 x i32> <i32 1, i32 2, i32 0, i32 3>
  %exp = call <4 x half> @llvm.exp.v4f16(<4 x half> %shuffle)
  ret <4 x half> %exp
}

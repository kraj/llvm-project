...
; CHECK:       bb.blend.1:
; CHECK-NEXT:    %disc.1 = call i64 @llvm.ptrauth.blend(i64 %addr.1, i64 1234)
; CHECK-NEXT:    switch i32 %arg, label %bb.user [
; CHECK-NEXT:      i32 0, label %bb.blend.2
; CHECK-NEXT:      i32 3, label %bb.blend.2
; CHECK-NEXT:    ]
; CHECK:       bb.blend.2:
; CHECK-NEXT:    %disc.2 = call i64 @llvm.ptrauth.blend(i64 %addr.2, i64 1234)
; CHECK-NEXT:    br label %bb.user
...
bb.blend.1:
  %disc.1 = call i64 @llvm.ptrauth.blend(i64 %addr.1, i64 1234)
  switch i32 %arg, label %bb.user [i32 0, label %bb.blend.2 i32 2, label %bb.user i32 3, label %bb.blend.2]
bb.blend.2:
  %disc.2 = call i64 @llvm.ptrauth.blend(i64 %addr.2, i64 1234)
  br label %bb.user
bb.user:

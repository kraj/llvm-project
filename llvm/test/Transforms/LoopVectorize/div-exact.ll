...
; CHECK-NEXT:    [[TMP25:%.*]] = load <4 x i32>, ptr [[TMP10]], align 4
; CHECK-NEXT:    [[TMP28:%.*]] = udiv exact <4 x i32> splat (i32 100), [[TMP25]]
; CHECK-NEXT:    store <4 x i32> [[TMP28]], ptr [[TMP10]], align 4
...
; CHECK-NEXT:    [[TMP10:%.*]] = getelementptr i32, ptr [[P]], i32 [[TMP4]]
; CHECK-NEXT:    [[TMP25:%.*]] = load <4 x i32>, ptr [[TMP10]], align 4
; CHECK-NEXT:    [[TMP27:%.*]] = udiv exact <4 x i32> [[TMP25]], splat (i32 100)

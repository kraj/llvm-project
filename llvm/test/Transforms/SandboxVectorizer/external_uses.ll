...
; RUN: opt -passes=sandbox-vectorizer -sbvec-vec-reg-bits=1024 -sbvec-allow-non-pow2 -sbvec-passes="seed-collection<tr-save,top-down-vec,tr-accept>" %s -S | FileCheck %s --check-prefix=TOPDOWN
...
; TOPDOWN-NEXT:    [[VPACK:%.*]] = insertelement <2 x float> poison, float [[SUB0]], i32 0, !sandboxvec [[META0:![0-9]+]]
; TOPDOWN-NEXT:    [[VPACK1:%.*]] = insertelement <2 x float> [[VPACK]], float [[SUB1]], i32 1, !sandboxvec [[META0]]
; TOPDOWN-NEXT:    store <2 x float> [[VPACK1]], ptr [[PTR0]], align 4, !sandboxvec [[META0]]
...
; TOPDOWN-NEXT:    [[VPACK:%.*]] = insertelement <2 x i32> poison, i32 [[ZEXT0]], i32 0, !sandboxvec [[META1:![0-9]+]]
; TOPDOWN-NEXT:    [[VPACK1:%.*]] = insertelement <2 x i32> [[VPACK]], i32 [[ZEXT1]], i32 1, !sandboxvec [[META1]]
; TOPDOWN-NEXT:    store <2 x i32> [[VPACK1]], ptr [[PTR0]], align 4, !sandboxvec [[META1]]
...
; TOPDOWN-NEXT:    [[VPACK:%.*]] = insertelement <3 x float> poison, float [[SUB0]], i32 0, !sandboxvec [[META2:![0-9]+]]
; TOPDOWN-NEXT:    [[VPACK1:%.*]] = extractelement <2 x float> [[SUB1]], i32 0, !sandboxvec [[META2]]
; TOPDOWN-NEXT:    [[VPACK2:%.*]] = insertelement <3 x float> [[VPACK]], float [[VPACK1]], i32 1, !sandboxvec [[META2]]
; TOPDOWN-NEXT:    [[VPACK3:%.*]] = extractelement <2 x float> [[SUB1]], i32 1, !sandboxvec [[META2]]
; TOPDOWN-NEXT:    [[VPACK4:%.*]] = insertelement <3 x float> [[VPACK2]], float [[VPACK3]], i32 2, !sandboxvec [[META2]]
; TOPDOWN-NEXT:    store <3 x float> [[VPACK4]], ptr [[PTR0]], align 4, !sandboxvec [[META2]]

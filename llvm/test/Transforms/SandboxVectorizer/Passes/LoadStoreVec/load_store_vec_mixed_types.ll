...
; CHECK-SAME: ptr [[PTR:%.*]]) {
; CHECK-NEXT:    store <2 x float> <float 1.000000e+00, float poison>, ptr [[PTR]], align 1, !sandboxvec [[META26:![0-9]+]]
; CHECK-NEXT:    ret void
;
  %ptr.4 = getelementptr i8, ptr %ptr, i64 4
  store float 1.0, ptr %ptr
...
; CHECK-SAME: ptr [[PTR:%.*]]) {
; CHECK-NEXT:    store <4 x i32> <i32 1, i32 2, i32 -1985229329, i32 19088743>, ptr [[PTR]], align 1, !sandboxvec [[META27:![0-9]+]]
; CHECK-NEXT:    ret void
;
  %ptr.4 = getelementptr i8, ptr %ptr, i64 4
  %ptr.8 = getelementptr i8, ptr %ptr, i64 8
...
; CHECK-SAME: ptr [[PTR:%.*]]) {
; CHECK-NEXT:    store <4 x i32> <i32 1, i32 2, i32 0, i32 1072693248>, ptr [[PTR]], align 1, !sandboxvec [[META28:![0-9]+]]
; CHECK-NEXT:    ret void
;
  %ptr.4 = getelementptr i8, ptr %ptr, i64 4
  %ptr.8 = getelementptr i8, ptr %ptr, i64 8
...
; CHECK-SAME: ptr [[PTR:%.*]]) {
; CHECK-NEXT:    store <4 x i32> <i32 1, i32 2, i32 0, i32 0>, ptr [[PTR]], align 1, !sandboxvec [[META29:![0-9]+]]
; CHECK-NEXT:    ret void
;
  %ptr.4 = getelementptr i8, ptr %ptr, i64 4
  %ptr.8 = getelementptr i8, ptr %ptr, i64 8
...
; CHECK-SAME: ptr [[PTR:%.*]]) {
; CHECK-NEXT:    store <4 x ptr> <ptr null, ptr null, ptr inttoptr (i64 5 to ptr), ptr null>, ptr [[PTR]], align 1, !sandboxvec [[META30:![0-9]+]]
; CHECK-NEXT:    ret void
;
  %ptr.8 = getelementptr i8, ptr %ptr, i64 8
...
; CHECK-SAME: ptr [[PTR:%.*]]) {
; CHECK-NEXT:    store <4 x half> <half 1.000000e+00, half 2.000000e+00, half 4.172330e-07, half 0.000000e+00>, ptr [[PTR]], align 1, !sandboxvec [[META31:![0-9]+]]
; CHECK-NEXT:    ret void
;
...
; CHECK-SAME: ptr [[PTR:%.*]]) {
; CHECK-NEXT:    store <4 x bfloat> <bfloat 1.000000e+00, bfloat 2.000000e+00, bfloat 0.000000e+00, bfloat 3.000000e+00>, ptr [[PTR]], align 1, !sandboxvec [[META32:![0-9]+]]
; CHECK-NEXT:    ret void
;
  %ptr.2 = getelementptr i8, ptr %ptr, i64 2
  %ptr.4 = getelementptr i8, ptr %ptr, i64 4
...
; CHECK-SAME: ptr [[PTR:%.*]]) {
; CHECK-NEXT:    store <4 x i8> <i8 1, i8 2, i8 4, i8 3>, ptr [[PTR]], align 1, !sandboxvec [[META33:![0-9]+]]
; CHECK-NEXT:    ret void
;
  %ptr.2 = getelementptr i8, ptr %ptr, i64 2
...
; CHECK-SAME: ptr [[PTR:%.*]]) {
; CHECK-NEXT:    store <8 x float> <float 1.401300e-45, float 0.000000e+00, float 0.000000e+00, float 2.000000e+00, float 0.000000e+00, float 0.000000e+00, float 3.000000e+00, float 4.000000e+00>, ptr [[PTR]], align 1, !sandboxvec [[META34:![0-9]+]]
; CHECK-NEXT:    ret void
;
  %ptr.8 = getelementptr i8, ptr %ptr, i64 8
  %ptr.16 = getelementptr i8, ptr %ptr, i64 16
...
; CHECK-SAME: ptr [[PTR:%.*]]) {
; CHECK-NEXT:    store <4 x i32> <i32 1, i32 2, i32 1077936128, i32 1082130432>, ptr [[PTR]], align 1, !sandboxvec [[META35:![0-9]+]]
; CHECK-NEXT:    ret void
;
  %ptr.8 = getelementptr i8, ptr %ptr, i64 8
...
; CHECK-SAME: ptr [[PTR:%.*]]) {
; CHECK-NEXT:    store <4 x float> <float 0.000000e+00, float 0.000000e+00, float 7.006490e-45, float 8.407790e-45>, ptr [[PTR]], align 1, !sandboxvec [[META36:![0-9]+]]
; CHECK-NEXT:    ret void
;
  %ptr.8 = getelementptr i8, ptr %ptr, i64 8
...
; CHECK-SAME: ptr [[PTR:%.*]]) {
; CHECK-NEXT:    store <4 x i32> zeroinitializer, ptr [[PTR]], align 1, !sandboxvec [[META37:![0-9]+]]
; CHECK-NEXT:    ret void
;
  %ptr.8 = getelementptr i8, ptr %ptr, i64 8
...
; CHECK-SAME: ptr [[PTR:%.*]]) {
; CHECK-NEXT:    store <4 x i32> <i32 7, i32 7, i32 1077936128, i32 1082130432>, ptr [[PTR]], align 1, !sandboxvec [[META38:![0-9]+]]
; CHECK-NEXT:    ret void
;
  %ptr.8 = getelementptr i8, ptr %ptr, i64 8
...
; CHECK-SAME: ptr [[PTR:%.*]]) {
; CHECK-NEXT:    store <4 x float> <float 2.000000e+00, float 2.000000e+00, float 1.261170e-44, float 1.401300e-44>, ptr [[PTR]], align 1, !sandboxvec [[META39:![0-9]+]]
; CHECK-NEXT:    ret void
;
  %ptr.8 = getelementptr i8, ptr %ptr, i64 8
...
; CHECK-SAME: ptr [[PTR:%.*]]) {
; CHECK-NEXT:    store <4 x ptr> <ptr @g, ptr null, ptr inttoptr (i64 3 to ptr), ptr inttoptr (i64 4 to ptr)>, ptr [[PTR]], align 1, !sandboxvec [[META40:![0-9]+]]
; CHECK-NEXT:    ret void
;
  %ptr.16 = getelementptr i8, ptr %ptr, i64 16
  %ptr.24 = getelementptr i8, ptr %ptr, i64 24
...
; CHECK-SAME: ptr [[OUT:%.*]]) {
; CHECK-NEXT:    store <4 x ptr> splat (ptr null), ptr [[OUT]], align 1, !sandboxvec [[META41:![0-9]+]]
; CHECK-NEXT:    ret void
;
...
; CHECK-NEXT:    store <2 x i32> poison, ptr [[PTR]], align 8, !sandboxvec [[META43:![0-9]+]]
; CHECK-NEXT:    store <2 x float> <float 3.000000e+00, float 4.000000e+00>, ptr [[PTR_8]], align 8, !sandboxvec [[META43]]
; CHECK-NEXT:    ret void
;
  %ptr.8 = getelementptr i8, ptr %ptr, i64 8
...
; CHECK-NEXT:    store ptr @g, ptr [[PTR_8]], align 8, !sandboxvec [[META45:![0-9]+]]
; CHECK-NEXT:    ret void
;
  %ptr.4 = getelementptr i8, ptr %ptr, i64 4
  %ptr.8 = getelementptr i8, ptr %ptr, i64 8
...
; CHECK-SAME: ptr [[PTR:%.*]]) {
; CHECK-NEXT:    [[PTR_8:%.*]] = getelementptr i8, ptr [[PTR]], i64 8
; CHECK-NEXT:    store <2 x i32> <i32 1, i32 2>, ptr [[PTR]], align 1, !sandboxvec [[META46:![0-9]+]]
; CHECK-NEXT:    store ptr getelementptr (i32, ptr @arr, i64 2), ptr [[PTR_8]], align 8, !sandboxvec [[META47:![0-9]+]]
; CHECK-NEXT:    ret void
;
  %ptr.4 = getelementptr i8, ptr %ptr, i64 4
  %ptr.8 = getelementptr i8, ptr %ptr, i64 8
...
; CHECK-NEXT:    store i64 5, ptr addrspace(5) [[PTR]], align 4, !sandboxvec [[META48:![0-9]+]]
; CHECK-NEXT:    store ptr addrspace(5) null, ptr addrspace(5) [[PTR_8]], align 8, !sandboxvec [[META48]]
; CHECK-NEXT:    ret void
;
...
; CHECK-NEXT:    store i32 1, ptr [[PTR]], align 4, !sandboxvec [[META49:![0-9]+]]
; CHECK-NEXT:    store float [[LD]], ptr [[PTR_4]], align 4, !sandboxvec [[META49]]
; CHECK-NEXT:    ret void
;
  %ptr.4 = getelementptr i8, ptr %ptr, i64 4
...
; CHECK-NEXT:    store i32 1, ptr [[PTR]], align 4, !sandboxvec [[META50:![0-9]+]]
; CHECK-NEXT:    store i24 2, ptr [[PTR_4]], align 4, !sandboxvec [[META50]]
; CHECK-NEXT:    store i24 3, ptr [[PTR_7]], align 4, !sandboxvec [[META50]]
; CHECK-NEXT:    store i24 4, ptr [[PTR_10]], align 4, !sandboxvec [[META50]]
; CHECK-NEXT:    store i24 5, ptr [[PTR_13]], align 4, !sandboxvec [[META50]]
; CHECK-NEXT:    ret void
;
  %ptr.4 = getelementptr i8, ptr %ptr, i64 4
...
; CHECK: [[META49]] = distinct !{!"sandboxregion"}
; CHECK: [[META50]] = distinct !{!"sandboxregion"}
;.

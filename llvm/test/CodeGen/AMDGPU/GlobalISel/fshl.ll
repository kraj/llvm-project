...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-TRUE16-LABEL: s_fshl_v2i8:
; GFX11-TRUE16:       ; %bb.0:
; GFX11-TRUE16-NEXT:    s_and_b32 s4, 0xffff, s2
; GFX11-TRUE16-NEXT:    s_and_b32 s3, 0xffff, s0
; GFX11-TRUE16-NEXT:    s_lshr_b32 s4, s4, 8
; GFX11-TRUE16-NEXT:    s_and_b32 s5, s2, 7
; GFX11-TRUE16-NEXT:    s_and_b32 s6, s1, 0xff
; GFX11-TRUE16-NEXT:    s_and_b32 s1, 0xffff, s1
; GFX11-TRUE16-NEXT:    s_lshr_b32 s3, s3, 8
; GFX11-TRUE16-NEXT:    s_lshl_b32 s0, s0, s5
; GFX11-TRUE16-NEXT:    s_lshr_b32 s5, s6, 1
; GFX11-TRUE16-NEXT:    s_and_b32 s6, s4, 7
; GFX11-TRUE16-NEXT:    s_lshr_b32 s1, s1, 9
; GFX11-TRUE16-NEXT:    s_and_not1_b32 s4, 7, s4
; GFX11-TRUE16-NEXT:    s_and_not1_b32 s2, 7, s2
; GFX11-TRUE16-NEXT:    s_lshl_b32 s3, s3, s6
; GFX11-TRUE16-NEXT:    s_lshr_b32 s1, s1, s4
; GFX11-TRUE16-NEXT:    s_lshr_b32 s2, s5, s2
; GFX11-TRUE16-NEXT:    s_or_b32 s1, s3, s1
...
;
; GFX11-FAKE16-LABEL: s_fshl_v2i8:
; GFX11-FAKE16:       ; %bb.0:
; GFX11-FAKE16-NEXT:    s_lshr_b32 s4, s1, 8
; GFX11-FAKE16-NEXT:    s_lshr_b32 s5, s2, 8
; GFX11-FAKE16-NEXT:    s_and_b32 s6, s2, 7
...
; GFX11-FAKE16-NEXT:    s_lshr_b32 s4, s4, 1
; GFX11-FAKE16-NEXT:    s_and_not1_b32 s5, 7, s5
; GFX11-FAKE16-NEXT:    s_lshr_b32 s1, s1, 1
; GFX11-FAKE16-NEXT:    s_and_not1_b32 s2, 7, s2
; GFX11-FAKE16-NEXT:    s_lshl_b32 s3, s3, s6
; GFX11-FAKE16-NEXT:    s_lshr_b32 s4, s4, s5

...
; COEXEC-NEXT:    v_dual_mov_b32 v116, s7 :: v_dual_mov_b32 v120, s8
; COEXEC-NEXT:    s_and_b32 vcc_lo, exec_lo, s0
; COEXEC-NEXT:    ds_load_tr16_b128 v[32:35], v120
; COEXEC-NEXT:    ds_load_tr16_b128 v[36:39], v120 offset:64
; COEXEC-NEXT:    ds_load_tr16_b128 v[40:43], v116
; COEXEC-NEXT:    ds_load_tr16_b128 v[44:47], v116 offset:64
; COEXEC-NEXT:    s_wait_dscnt 0x0
; COEXEC-NEXT:    v_wmma_f32_16x16x32_f16 v[24:31], v[40:47], v[32:39], v[24:31]
; COEXEC-NEXT:    ds_load_tr16_b128 v[52:55], v116 offset:320
; COEXEC-NEXT:    ds_load_tr16_b128 v[60:63], v120 offset:320
; COEXEC-NEXT:    ds_load_tr16_b128 v[48:51], v116 offset:256
; COEXEC-NEXT:    v_wmma_f32_16x16x32_f16 v[24:31], v[40:47], v[32:39], v[24:31]
; COEXEC-NEXT:    ds_load_tr16_b128 v[56:59], v120 offset:256
; COEXEC-NEXT:    s_wait_dscnt 0x0
; COEXEC-NEXT:    v_wmma_f32_16x16x32_f16 v[16:23], v[48:55], v[56:63], v[16:23]
; COEXEC-NEXT:    s_delay_alu instid0(TRANS32_DEP_1)
; COEXEC-NEXT:    v_wmma_f32_16x16x32_f16 v[16:23], v[48:55], v[56:63], v[16:23]
; COEXEC-NEXT:    ds_load_tr16_b128 v[36:39], v116 offset:576
; COEXEC-NEXT:    ds_load_tr16_b128 v[44:47], v120 offset:576
; COEXEC-NEXT:    ds_load_tr16_b128 v[32:35], v116 offset:512
; COEXEC-NEXT:    ds_load_tr16_b128 v[40:43], v120 offset:512
; COEXEC-NEXT:    ds_load_tr16_b128 v[52:55], v116 offset:832
; COEXEC-NEXT:    ds_load_tr16_b128 v[60:63], v120 offset:832
; COEXEC-NEXT:    ds_load_tr16_b128 v[48:51], v116 offset:768
; COEXEC-NEXT:    s_wait_dscnt 0x3
; COEXEC-NEXT:    v_wmma_f32_16x16x32_f16 v[8:15], v[32:39], v[40:47], v[8:15]
; COEXEC-NEXT:    ds_load_tr16_b128 v[56:59], v120 offset:768
; COEXEC-NEXT:    ds_load_tr16_b128 v[64:67], v116 offset:128
; COEXEC-NEXT:    ds_load_tr16_b128 v[68:71], v116 offset:192
; COEXEC-NEXT:    ds_load_tr16_b128 v[72:75], v116 offset:384
; COEXEC-NEXT:    ds_load_tr16_b128 v[76:79], v116 offset:448
; COEXEC-NEXT:    ds_load_tr16_b128 v[80:83], v116 offset:640
; COEXEC-NEXT:    ds_load_tr16_b128 v[84:87], v116 offset:704
; COEXEC-NEXT:    s_wait_dscnt 0x6
; COEXEC-NEXT:    v_wmma_f32_16x16x32_f16 v[0:7], v[48:55], v[56:63], v[0:7]
; COEXEC-NEXT:    ds_load_tr16_b128 v[88:91], v120 offset:128
; COEXEC-NEXT:    ds_load_tr16_b128 v[92:95], v120 offset:192
; COEXEC-NEXT:    ds_load_tr16_b128 v[96:99], v120 offset:384
; COEXEC-NEXT:    ds_load_tr16_b128 v[100:103], v120 offset:448
; COEXEC-NEXT:    ds_load_tr16_b128 v[108:111], v120 offset:704
; COEXEC-NEXT:    ds_load_tr16_b128 v[104:107], v120 offset:640
; COEXEC-NEXT:    ds_load_tr16_b128 v[112:115], v116 offset:896
; COEXEC-NEXT:    v_wmma_f32_16x16x32_f16 v[8:15], v[32:39], v[40:47], v[8:15]
; COEXEC-NEXT:    ds_load_tr16_b128 v[36:39], v120 offset:960
; COEXEC-NEXT:    ds_load_tr16_b128 v[116:119], v116 offset:960
; COEXEC-NEXT:    ds_load_tr16_b128 v[32:35], v120 offset:896
; COEXEC-NEXT:    v_wmma_f32_16x16x32_f16 v[0:7], v[48:55], v[56:63], v[0:7]
; COEXEC-NEXT:    s_wait_dscnt 0x8
; COEXEC-NEXT:    v_wmma_f32_16x16x32_f16 v[24:31], v[64:71], v[88:95], v[24:31]
; COEXEC-NEXT:    s_wait_dscnt 0x6
; COEXEC-NEXT:    v_wmma_f32_16x16x32_f16 v[16:23], v[72:79], v[96:103], v[16:23]
; COEXEC-NEXT:    s_wait_dscnt 0x4
; COEXEC-NEXT:    v_wmma_f32_16x16x32_f16 v[8:15], v[80:87], v[104:111], v[8:15]
; COEXEC-NEXT:    s_wait_dscnt 0x0
; COEXEC-NEXT:    v_wmma_f32_16x16x32_f16 v[0:7], v[112:119], v[32:39], v[0:7]
; COEXEC-NEXT:    v_wmma_f32_16x16x32_f16 v[24:31], v[64:71], v[88:95], v[24:31]
; COEXEC-NEXT:    v_wmma_f32_16x16x32_f16 v[16:23], v[72:79], v[96:103], v[16:23]
; COEXEC-NEXT:    v_wmma_f32_16x16x32_f16 v[8:15], v[80:87], v[104:111], v[8:15]
; COEXEC-NEXT:    v_wmma_f32_16x16x32_f16 v[0:7], v[112:119], v[32:39], v[0:7]

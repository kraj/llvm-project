...
; NONEON-NOSVE-NEXT:    csel w8, w8, w9, ne
; NONEON-NOSVE-NEXT:    ldrb w9, [sp, #93]
; NONEON-NOSVE-NEXT:    strb w8, [sp, #14]
...
; NONEON-NOSVE-NEXT:    csel w8, w8, w9, ne
; NONEON-NOSVE-NEXT:    ldrb w9, [sp, #91]
; NONEON-NOSVE-NEXT:    strb w8, [sp, #12]
...
; NONEON-NOSVE-NEXT:    csel w8, w8, w9, ne
; NONEON-NOSVE-NEXT:    ldrb w9, [sp, #89]
; NONEON-NOSVE-NEXT:    strb w8, [sp, #10]
...
; NONEON-NOSVE-NEXT:    csel w8, w8, w9, ne
; NONEON-NOSVE-NEXT:    ldrb w9, [sp, #87]
; NONEON-NOSVE-NEXT:    strb w8, [sp, #8]
...
; NONEON-NOSVE-NEXT:    csel w8, w8, w9, ne
; NONEON-NOSVE-NEXT:    ldrb w9, [sp, #85]
; NONEON-NOSVE-NEXT:    strb w8, [sp, #6]
...
; NONEON-NOSVE-NEXT:    csel w8, w8, w9, ne
; NONEON-NOSVE-NEXT:    ldrb w9, [sp, #83]
; NONEON-NOSVE-NEXT:    strb w8, [sp, #4]
...
; NONEON-NOSVE-NEXT:    csel w8, w8, w9, ne
; NONEON-NOSVE-NEXT:    ldp w9, w10, [sp, #16]
; NONEON-NOSVE-NEXT:    stp w8, w11, [sp, #56]
...
; NONEON-NOSVE-NEXT:    stp q0, q2, [sp]
; NONEON-NOSVE-NEXT:    stp q1, q3, [sp, #64]
; NONEON-NOSVE-NEXT:    ldp x9, x10, [sp, #80]

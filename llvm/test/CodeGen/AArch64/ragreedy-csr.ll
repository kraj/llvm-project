...
; CHECK-NEXT:    stp x10, x0, [sp, #8] ; 16-byte Folded Spill
; CHECK-NEXT:    mov w0, w8
; CHECK-NEXT:    mov w1, #32768 ; =0x8000
; CHECK-NEXT:    stp x11, x9, [sp, #32] ; 16-byte Folded Spill
; CHECK-NEXT:    stp w12, w13, [sp, #24] ; 8-byte Folded Spill
...
; CHECK-NEXT:  Lloh3:
; CHECK-NEXT:    ldr x14, [x14, __DefaultRuneLocale@GOTPAGEOFF]
; CHECK-NEXT:    ldp x11, x9, [sp, #32] ; 16-byte Folded Reload
; CHECK-NEXT:    ldp w12, w13, [sp, #24] ; 8-byte Folded Reload
; CHECK-NEXT:    ldp x10, x0, [sp, #8] ; 16-byte Folded Reload

...
; CHECK-NEXT:    stp w2, w1, [sp, #36]
; CHECK-NEXT:    stp w4, w3, [sp, #20]
; CHECK-NEXT:    stp w6, w5, [sp, #28]
; CHECK-NEXT:    str w7, [sp, #56]

...
; CHECK-NEXT:    ldp q3, q2, [sp] ; 32-byte Folded Reload
; CHECK-NEXT:    ldp q5, q4, [sp, #64] ; 32-byte Folded Reload
; CHECK-NEXT:    ldp q7, q6, [sp, #32] ; 32-byte Folded Reload
...
; CHECK-NEXT:    mov x25, x6
; CHECK-NEXT:    mov x26, x7
; CHECK-NEXT:    stp q6, q5, [sp] ; 32-byte Folded Spill
; CHECK-NEXT:    stp q3, q2, [sp, #32] ; 32-byte Folded Spill
; CHECK-NEXT:    stp q1, q0, [sp, #64] ; 32-byte Folded Spill
; CHECK-NEXT:    stp q7, q4, [sp, #96] ; 32-byte Folded Spill
...
; CHECK-NEXT:    mov x8, x27
; CHECK-NEXT:    ldp q3, q2, [sp, #32] ; 32-byte Folded Reload
; CHECK-NEXT:    ldp q7, q4, [sp, #96] ; 32-byte Folded Reload
; CHECK-NEXT:    ldp q6, q5, [sp] ; 32-byte Folded Reload

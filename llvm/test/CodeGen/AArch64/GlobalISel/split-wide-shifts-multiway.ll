...
; SDAG-LABEL: test_shl_i1024_variable_edge:
; SDAG:       ; %bb.0: ; %entry
; SDAG-NEXT:    sub sp, sp, #352
; SDAG-NEXT:    stp x28, x27, [sp, #256] ; 16-byte Folded Spill
; SDAG-NEXT:    stp x26, x25, [sp, #272] ; 16-byte Folded Spill
...
; SDAG-NEXT:    ret
;
; GISEL-LABEL: test_shl_i1024_variable_edge:
; GISEL:       ; %bb.0: ; %entry
; GISEL-NEXT:    sub sp, sp, #416
; GISEL-NEXT:    stp x28, x27, [sp, #320] ; 16-byte Folded Spill
; GISEL-NEXT:    stp x26, x25, [sp, #336] ; 16-byte Folded Spill
...
entry:
  %input_val = load i1024, ptr %input, align 128
  %shift_masked = and i32 %shift, 1023
  %shift_ext = zext i32 %shift_masked to i1024
  %shifted = shl i1024 %input_val, %shift_ext
  store i1024 %shifted, ptr %result, align 128
  ret void
}

define void @test_lshr_i1024_variable_edge(ptr %result, ptr %input, i32 %shift) {
; SDAG-LABEL: test_lshr_i1024_variable_edge:
; SDAG:       ; %bb.0: ; %entry
; SDAG-NEXT:    sub sp, sp, #336
; SDAG-NEXT:    stp x28, x27, [sp, #256] ; 16-byte Folded Spill
; SDAG-NEXT:    stp x26, x25, [sp, #272] ; 16-byte Folded Spill
...
; SDAG-NEXT:    ret
;
; GISEL-LABEL: test_lshr_i1024_variable_edge:
; GISEL:       ; %bb.0: ; %entry
; GISEL-NEXT:    sub sp, sp, #416
; GISEL-NEXT:    stp x28, x27, [sp, #320] ; 16-byte Folded Spill
; GISEL-NEXT:    stp x26, x25, [sp, #336] ; 16-byte Folded Spill
...
define void @test_ashr_i1024_variable_edge(ptr %result, ptr %input, i32 %shift) {
; SDAG-LABEL: test_ashr_i1024_variable_edge:
; SDAG:       ; %bb.0: ; %entry
; SDAG-NEXT:    sub sp, sp, #336
; SDAG-NEXT:    stp x28, x27, [sp, #256] ; 16-byte Folded Spill
; SDAG-NEXT:    stp x26, x25, [sp, #272] ; 16-byte Folded Spill
...
; SDAG-NEXT:    ret
;
; GISEL-LABEL: test_ashr_i1024_variable_edge:
; GISEL:       ; %bb.0: ; %entry
; GISEL-NEXT:    sub sp, sp, #432
; GISEL-NEXT:    stp x28, x27, [sp, #336] ; 16-byte Folded Spill
; GISEL-NEXT:    stp x26, x25, [sp, #352] ; 16-byte Folded Spill

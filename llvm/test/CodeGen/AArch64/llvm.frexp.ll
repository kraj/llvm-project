...
; WINDOWS-NEXT:    str q0, [sp, #32] // 16-byte Folded Spill
; WINDOWS-NEXT:    add x0, sp, #12
; WINDOWS-NEXT:    stp x30, x19, [sp, #64] // 16-byte Folded Spill
; WINDOWS-NEXT:    add x19, sp, #12
; WINDOWS-NEXT:    fcvt d0, h1
; WINDOWS-NEXT:    bl frexp
; WINDOWS-NEXT:    ldr q1, [sp, #32] // 16-byte Folded Reload
; WINDOWS-NEXT:    fcvt h0, d0
; WINDOWS-NEXT:    add x0, sp, #8
...
; WINDOWS-NEXT:    str q2, [sp, #16] // 16-byte Folded Spill
; WINDOWS-NEXT:    bl frexp
; WINDOWS-NEXT:    ldr q1, [sp, #32] // 16-byte Folded Reload
; WINDOWS-NEXT:    fcvt h2, d0
...
; WINDOWS-NEXT:    str q1, [sp, #16] // 16-byte Folded Spill
; WINDOWS-NEXT:    bl frexp
; WINDOWS-NEXT:    fcvt h2, d0
; WINDOWS-NEXT:    ldr s1, [sp, #8]
; WINDOWS-NEXT:    ldr q0, [sp, #16] // 16-byte Folded Reload
; WINDOWS-NEXT:    ld1 { v1.s }[1], [x19]
; WINDOWS-NEXT:    ldp x30, x19, [sp, #64] // 16-byte Folded Reload
...
; WINDOWS:       // %bb.0:
; WINDOWS-NEXT:    sub sp, sp, #96
; WINDOWS-NEXT:    mov s1, v0.s[1]
; WINDOWS-NEXT:    str q0, [sp, #32] // 16-byte Folded Spill
; WINDOWS-NEXT:    add x0, sp, #12
; WINDOWS-NEXT:    stp x30, x21, [sp, #64] // 16-byte Folded Spill
; WINDOWS-NEXT:    stp x20, x19, [sp, #80] // 16-byte Folded Spill
; WINDOWS-NEXT:    add x19, sp, #12
...
; WINDOWS-NEXT:    add x0, sp, #8
; WINDOWS-NEXT:    str q0, [sp, #16] // 16-byte Folded Spill
; WINDOWS-NEXT:    ldr q0, [sp, #32] // 16-byte Folded Reload
; WINDOWS-NEXT:    fcvt d0, s0
; WINDOWS-NEXT:    bl frexp
; WINDOWS-NEXT:    fcvt s0, d0
; WINDOWS-NEXT:    ldr q1, [sp, #16] // 16-byte Folded Reload
; WINDOWS-NEXT:    add x0, sp, #56
; WINDOWS-NEXT:    add x20, sp, #56
...
; WINDOWS-NEXT:    ldp x20, x19, [sp, #80] // 16-byte Folded Reload
; WINDOWS-NEXT:    ld1 { v1.s }[3], [x21]
; WINDOWS-NEXT:    ldp x30, x21, [sp, #64] // 16-byte Folded Reload
; WINDOWS-NEXT:    add sp, sp, #96
; WINDOWS-NEXT:    ret
...
; CHECK-NEXT:    mov s0, v0.s[1]
; CHECK-NEXT:    add x0, sp, #8
; CHECK-NEXT:    stp x30, x21, [sp, #64] // 16-byte Folded Spill
...
; CHECK-NEXT:    ldp x30, x21, [sp, #64] // 16-byte Folded Reload
...
; WINDOWS-NEXT:    str q0, [sp, #16] // 16-byte Folded Spill
; WINDOWS-NEXT:    fcvt d0, s0
; WINDOWS-NEXT:    mov x0, sp
; WINDOWS-NEXT:    stp x30, x21, [sp, #32] // 16-byte Folded Spill
; WINDOWS-NEXT:    stp x20, x19, [sp, #48] // 16-byte Folded Spill
; WINDOWS-NEXT:    bl frexp
; WINDOWS-NEXT:    ldr q0, [sp, #16] // 16-byte Folded Reload
; WINDOWS-NEXT:    add x0, sp, #8
; WINDOWS-NEXT:    add x19, sp, #8
; WINDOWS-NEXT:    mov s0, v0.s[1]
; WINDOWS-NEXT:    fcvt d0, s0
; WINDOWS-NEXT:    bl frexp
; WINDOWS-NEXT:    ldr q0, [sp, #16] // 16-byte Folded Reload
; WINDOWS-NEXT:    add x0, sp, #12
; WINDOWS-NEXT:    add x20, sp, #12
; WINDOWS-NEXT:    mov s0, v0.s[2]
; WINDOWS-NEXT:    fcvt d0, s0
; WINDOWS-NEXT:    bl frexp
; WINDOWS-NEXT:    ldr q0, [sp, #16] // 16-byte Folded Reload
; WINDOWS-NEXT:    add x0, sp, #4
; WINDOWS-NEXT:    add x21, sp, #4
; WINDOWS-NEXT:    mov s0, v0.s[3]
; WINDOWS-NEXT:    fcvt d0, s0
; WINDOWS-NEXT:    bl frexp
; WINDOWS-NEXT:    ldr s0, [sp]
; WINDOWS-NEXT:    ld1 { v0.s }[1], [x19]
...
; WINDOWS-NEXT:    // kill: def $d0 killed $d0 killed $q0
; WINDOWS-NEXT:    bl frexp
; WINDOWS-NEXT:    ldr s1, [sp, #12]
; WINDOWS-NEXT:    ldr q2, [sp, #32] // 16-byte Folded Reload
; WINDOWS-NEXT:    // kill: def $d0 killed $d0 def $q0
; WINDOWS-NEXT:    ld1 { v1.s }[1], [x19]

...
; CHECK-NEXT:    stp q6, q1, [sp, #16] // 32-byte Folded Spill
; CHECK-NEXT:    stp q3, q2, [sp, #64] // 32-byte Folded Spill
; CHECK-NEXT:    stp q5, q4, [sp, #96] // 32-byte Folded Spill
; CHECK-NEXT:    bl llrintl
; CHECK-NEXT:    fmov d0, x0
; CHECK-NEXT:    str q0, [sp] // 16-byte Folded Spill
; CHECK-NEXT:    ldr q0, [sp, #16] // 16-byte Folded Reload
...
; CHECK-NEXT:    addvl x8, sp, #4
; CHECK-NEXT:    str q0, [sp, #32] // 16-byte Folded Spill
; CHECK-NEXT:    stp q7, q6, [sp, #160] // 32-byte Folded Spill
; CHECK-NEXT:    str q1, [sp, #144] // 16-byte Folded Spill
; CHECK-NEXT:    ldr q1, [x8, #288]
; CHECK-NEXT:    addvl x8, sp, #4
; CHECK-NEXT:    stp q3, q2, [sp, #192] // 32-byte Folded Spill
; CHECK-NEXT:    str q1, [sp, #128] // 16-byte Folded Spill
; CHECK-NEXT:    ldr q1, [x8, #304]
; CHECK-NEXT:    addvl x8, sp, #4
; CHECK-NEXT:    stp q5, q4, [sp, #224] // 32-byte Folded Spill

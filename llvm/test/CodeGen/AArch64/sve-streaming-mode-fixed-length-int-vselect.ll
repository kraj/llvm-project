...
; NONEON-NOSVE-NEXT:    stp d2, d0, [sp, #8]
; NONEON-NOSVE-NEXT:    ldrh w9, [sp, #14]
; NONEON-NOSVE-NEXT:    str d1, [sp, #24]
...
; NONEON-NOSVE-NEXT:    strh w9, [sp, #6]
; NONEON-NOSVE-NEXT:    ldrh w9, [sp, #28]
; NONEON-NOSVE-NEXT:    ldrh w11, [sp, #18]
...
; NONEON-NOSVE-NEXT:    ldrb w14, [sp, #13]
...
; NONEON-NOSVE-NEXT:    strb w13, [sp, #7]
; NONEON-NOSVE-NEXT:    ldrb w13, [sp, #30]
...
; NONEON-NOSVE-NEXT:    strb w13, [sp, #6]
; NONEON-NOSVE-NEXT:    ldrb w13, [sp, #29]
...
; NONEON-NOSVE-NEXT:    ldrb w12, [sp, #27]
...
; NONEON-NOSVE-NEXT:    ldrb w11, [sp, #26]
; NONEON-NOSVE-NEXT:    csel w10, w12, w11, ne
; NONEON-NOSVE-NEXT:    ldrb w11, [sp, #17]
...
; NONEON-NOSVE-NEXT:    ldrb w2, [sp, #31]
; NONEON-NOSVE-NEXT:    str q1, [sp, #48]
; NONEON-NOSVE-NEXT:    ldrb w4, [sp, #30]
; NONEON-NOSVE-NEXT:    ldrb w5, [sp, #63]
; NONEON-NOSVE-NEXT:    ldrb w6, [sp, #47]
; NONEON-NOSVE-NEXT:    ldrb w3, [sp, #29]
; NONEON-NOSVE-NEXT:    sbfx w2, w2, #0, #1
; NONEON-NOSVE-NEXT:    sbfx w4, w4, #0, #1
; NONEON-NOSVE-NEXT:    ldrb w1, [sp, #28]
; NONEON-NOSVE-NEXT:    sbfx w3, w3, #0, #1
; NONEON-NOSVE-NEXT:    ldrb w0, [sp, #27]
; NONEON-NOSVE-NEXT:    ldrb w18, [sp, #26]
; NONEON-NOSVE-NEXT:    tst w2, #0xff
; NONEON-NOSVE-NEXT:    sbfx w1, w1, #0, #1
; NONEON-NOSVE-NEXT:    ldrb w17, [sp, #25]
; NONEON-NOSVE-NEXT:    csel w2, w6, w5, ne
; NONEON-NOSVE-NEXT:    ldrb w5, [sp, #46]
; NONEON-NOSVE-NEXT:    tst w4, #0xff
; NONEON-NOSVE-NEXT:    strb w2, [sp, #15]
; NONEON-NOSVE-NEXT:    ldrb w2, [sp, #62]
; NONEON-NOSVE-NEXT:    ldrb w4, [sp, #45]
...
; NONEON-NOSVE-NEXT:    ldrb w3, [sp, #44]
; NONEON-NOSVE-NEXT:    strb w2, [sp, #14]
; NONEON-NOSVE-NEXT:    ldrb w2, [sp, #61]
; NONEON-NOSVE-NEXT:    ldrb w16, [sp, #24]
...
; NONEON-NOSVE-NEXT:    strb w2, [sp, #13]
; NONEON-NOSVE-NEXT:    ldrb w2, [sp, #60]
; NONEON-NOSVE-NEXT:    sbfx w15, w15, #0, #1
; NONEON-NOSVE-NEXT:    sbfx w14, w14, #0, #1
; NONEON-NOSVE-NEXT:    sbfx w13, w13, #0, #1
...
; NONEON-NOSVE-NEXT:    strb w1, [sp, #12]
; NONEON-NOSVE-NEXT:    ldrb w1, [sp, #59]
; NONEON-NOSVE-NEXT:    sbfx w12, w12, #0, #1
...
; NONEON-NOSVE-NEXT:    ldrb w0, [sp, #58]
; NONEON-NOSVE-NEXT:    sbfx w11, w11, #0, #1
; NONEON-NOSVE-NEXT:    sbfx w10, w10, #0, #1
; NONEON-NOSVE-NEXT:    sbfx w9, w9, #0, #1
; NONEON-NOSVE-NEXT:    ldrb w8, [sp, #16]
; NONEON-NOSVE-NEXT:    csel w18, w1, w0, ne
; NONEON-NOSVE-NEXT:    ldrb w0, [sp, #41]
; NONEON-NOSVE-NEXT:    tst w17, #0xff
; NONEON-NOSVE-NEXT:    strb w18, [sp, #10]
; NONEON-NOSVE-NEXT:    ldrb w18, [sp, #57]
; NONEON-NOSVE-NEXT:    sbfx w8, w8, #0, #1
; NONEON-NOSVE-NEXT:    csel w17, w0, w18, ne
; NONEON-NOSVE-NEXT:    ldrb w18, [sp, #40]
; NONEON-NOSVE-NEXT:    tst w16, #0xff
; NONEON-NOSVE-NEXT:    strb w17, [sp, #9]
; NONEON-NOSVE-NEXT:    ldrb w17, [sp, #56]
; NONEON-NOSVE-NEXT:    csel w16, w18, w17, ne
; NONEON-NOSVE-NEXT:    ldrb w17, [sp, #39]
; NONEON-NOSVE-NEXT:    tst w15, #0xff
; NONEON-NOSVE-NEXT:    strb w16, [sp, #8]
; NONEON-NOSVE-NEXT:    ldrb w16, [sp, #55]
; NONEON-NOSVE-NEXT:    csel w15, w17, w16, ne
; NONEON-NOSVE-NEXT:    ldrb w16, [sp, #38]
; NONEON-NOSVE-NEXT:    tst w14, #0xff
; NONEON-NOSVE-NEXT:    strb w15, [sp, #7]
; NONEON-NOSVE-NEXT:    ldrb w15, [sp, #54]
; NONEON-NOSVE-NEXT:    csel w14, w16, w15, ne
; NONEON-NOSVE-NEXT:    ldrb w15, [sp, #37]
; NONEON-NOSVE-NEXT:    tst w13, #0xff
; NONEON-NOSVE-NEXT:    strb w14, [sp, #6]
; NONEON-NOSVE-NEXT:    ldrb w14, [sp, #53]
; NONEON-NOSVE-NEXT:    csel w13, w15, w14, ne
; NONEON-NOSVE-NEXT:    ldrb w14, [sp, #36]
; NONEON-NOSVE-NEXT:    tst w12, #0xff
; NONEON-NOSVE-NEXT:    strb w13, [sp, #5]
; NONEON-NOSVE-NEXT:    ldrb w13, [sp, #52]
; NONEON-NOSVE-NEXT:    csel w12, w14, w13, ne
; NONEON-NOSVE-NEXT:    ldrb w13, [sp, #35]
; NONEON-NOSVE-NEXT:    tst w11, #0xff
; NONEON-NOSVE-NEXT:    strb w12, [sp, #4]
; NONEON-NOSVE-NEXT:    ldrb w12, [sp, #51]
; NONEON-NOSVE-NEXT:    csel w11, w13, w12, ne
; NONEON-NOSVE-NEXT:    ldrb w12, [sp, #34]
; NONEON-NOSVE-NEXT:    tst w10, #0xff
; NONEON-NOSVE-NEXT:    strb w11, [sp, #3]
; NONEON-NOSVE-NEXT:    ldrb w11, [sp, #50]
; NONEON-NOSVE-NEXT:    csel w10, w12, w11, ne
; NONEON-NOSVE-NEXT:    ldrb w11, [sp, #33]
; NONEON-NOSVE-NEXT:    tst w9, #0xff
; NONEON-NOSVE-NEXT:    strb w10, [sp, #2]
; NONEON-NOSVE-NEXT:    ldrb w10, [sp, #49]
; NONEON-NOSVE-NEXT:    csel w9, w11, w10, ne
; NONEON-NOSVE-NEXT:    ldrb w10, [sp, #32]
; NONEON-NOSVE-NEXT:    tst w8, #0xff
; NONEON-NOSVE-NEXT:    strb w9, [sp, #1]
...
; NONEON-NOSVE-NEXT:    stp x29, x30, [sp, #128] // 16-byte Folded Spill
; NONEON-NOSVE-NEXT:    stp x28, x27, [sp, #144] // 16-byte Folded Spill
...
; NONEON-NOSVE-NEXT:    ldrb w10, [sp, #98]
; NONEON-NOSVE-NEXT:    ldrb w11, [sp, #82]
; NONEON-NOSVE-NEXT:    ldrb w12, [sp, #99]
; NONEON-NOSVE-NEXT:    ldrb w13, [sp, #83]
; NONEON-NOSVE-NEXT:    cmp w9, w8
; NONEON-NOSVE-NEXT:    ldrb w14, [sp, #100]
; NONEON-NOSVE-NEXT:    ldrb w16, [sp, #84]
; NONEON-NOSVE-NEXT:    csel w8, w9, w8, eq
; NONEON-NOSVE-NEXT:    cmp w11, w10
; NONEON-NOSVE-NEXT:    ldrb w18, [sp, #101]
; NONEON-NOSVE-NEXT:    csel w9, w11, w10, eq
; NONEON-NOSVE-NEXT:    cmp w13, w12
; NONEON-NOSVE-NEXT:    ldrb w1, [sp, #85]
; NONEON-NOSVE-NEXT:    str w8, [sp, #124] // 4-byte Folded Spill
; NONEON-NOSVE-NEXT:    csel w8, w13, w12, eq
; NONEON-NOSVE-NEXT:    cmp w16, w14
; NONEON-NOSVE-NEXT:    ldrb w13, [sp, #102]
; NONEON-NOSVE-NEXT:    ldrb w2, [sp, #86]
; NONEON-NOSVE-NEXT:    stp w8, w9, [sp, #8] // 8-byte Folded Spill
; NONEON-NOSVE-NEXT:    csel w8, w16, w14, eq
; NONEON-NOSVE-NEXT:    cmp w1, w18
; NONEON-NOSVE-NEXT:    ldrb w14, [sp, #103]
; NONEON-NOSVE-NEXT:    ldrb w16, [sp, #87]
; NONEON-NOSVE-NEXT:    csel w12, w1, w18, eq
; NONEON-NOSVE-NEXT:    cmp w2, w13
; NONEON-NOSVE-NEXT:    ldrb w18, [sp, #104]
; NONEON-NOSVE-NEXT:    ldrb w1, [sp, #88]
; NONEON-NOSVE-NEXT:    csel w13, w2, w13, eq
; NONEON-NOSVE-NEXT:    cmp w16, w14
; NONEON-NOSVE-NEXT:    ldrb w2, [sp, #105]
; NONEON-NOSVE-NEXT:    ldrb w5, [sp, #89]
; NONEON-NOSVE-NEXT:    csel w14, w16, w14, eq
; NONEON-NOSVE-NEXT:    cmp w1, w18
; NONEON-NOSVE-NEXT:    ldrb w6, [sp, #90]
; NONEON-NOSVE-NEXT:    csel w16, w1, w18, eq
; NONEON-NOSVE-NEXT:    ldrb w1, [sp, #106]
; NONEON-NOSVE-NEXT:    cmp w5, w2
; NONEON-NOSVE-NEXT:    csel w18, w5, w2, eq
; NONEON-NOSVE-NEXT:    ldrb w2, [sp, #107]
; NONEON-NOSVE-NEXT:    ldrb w5, [sp, #91]
; NONEON-NOSVE-NEXT:    cmp w6, w1
; NONEON-NOSVE-NEXT:    ldrb w19, [sp, #92]
; NONEON-NOSVE-NEXT:    ldrb w29, [sp, #109]
; NONEON-NOSVE-NEXT:    csel w1, w6, w1, eq
; NONEON-NOSVE-NEXT:    ldrb w6, [sp, #108]
; NONEON-NOSVE-NEXT:    cmp w5, w2
; NONEON-NOSVE-NEXT:    ldrb w30, [sp, #93]
; NONEON-NOSVE-NEXT:    str w8, [sp, #120] // 4-byte Folded Spill
; NONEON-NOSVE-NEXT:    csel w2, w5, w2, eq
; NONEON-NOSVE-NEXT:    ldrb w9, [sp, #110]
; NONEON-NOSVE-NEXT:    ldrb w8, [sp, #94]
; NONEON-NOSVE-NEXT:    cmp w19, w6
; NONEON-NOSVE-NEXT:    ldrb w21, [sp, #111]
; NONEON-NOSVE-NEXT:    ldrb w10, [sp, #95]
...
; NONEON-NOSVE-NEXT:    ldrb w28, [sp, #96]
...
; NONEON-NOSVE-NEXT:    strb w25, [sp, #78]
; NONEON-NOSVE-NEXT:    strb w26, [sp, #79]
...
; NONEON-NOSVE-NEXT:    cmp w29, w28
; NONEON-NOSVE-NEXT:    strb w27, [sp, #77]
; NONEON-NOSVE-NEXT:    strb w8, [sp, #49]
; NONEON-NOSVE-NEXT:    csel w8, w29, w28, eq
; NONEON-NOSVE-NEXT:    strb w15, [sp, #76]
; NONEON-NOSVE-NEXT:    ldp x28, x27, [sp, #144] // 16-byte Folded Reload
; NONEON-NOSVE-NEXT:    strb w17, [sp, #75]
; NONEON-NOSVE-NEXT:    ldp x29, x30, [sp, #128] // 16-byte Folded Reload
; NONEON-NOSVE-NEXT:    strb w3, [sp, #74]
; NONEON-NOSVE-NEXT:    strb w4, [sp, #73]
; NONEON-NOSVE-NEXT:    strb w7, [sp, #72]
; NONEON-NOSVE-NEXT:    strb w20, [sp, #71]
; NONEON-NOSVE-NEXT:    strb w23, [sp, #70]
; NONEON-NOSVE-NEXT:    strb w24, [sp, #69]
; NONEON-NOSVE-NEXT:    ldp x24, x23, [sp, #176] // 16-byte Folded Reload
; NONEON-NOSVE-NEXT:    strb w10, [sp, #68]
; NONEON-NOSVE-NEXT:    strb w11, [sp, #65]
; NONEON-NOSVE-NEXT:    strb w22, [sp, #64]
; NONEON-NOSVE-NEXT:    strb w21, [sp, #63]
; NONEON-NOSVE-NEXT:    ldp x22, x21, [sp, #192] // 16-byte Folded Reload
; NONEON-NOSVE-NEXT:    strb w19, [sp, #62]
; NONEON-NOSVE-NEXT:    ldp x20, x19, [sp, #208] // 16-byte Folded Reload
; NONEON-NOSVE-NEXT:    strb w6, [sp, #61]
; NONEON-NOSVE-NEXT:    strb w5, [sp, #60]
; NONEON-NOSVE-NEXT:    strb w2, [sp, #59]
; NONEON-NOSVE-NEXT:    strb w1, [sp, #58]
; NONEON-NOSVE-NEXT:    strb w18, [sp, #57]
; NONEON-NOSVE-NEXT:    strb w16, [sp, #56]
; NONEON-NOSVE-NEXT:    strb w14, [sp, #55]
; NONEON-NOSVE-NEXT:    strb w13, [sp, #54]
; NONEON-NOSVE-NEXT:    strb w12, [sp, #53]
...
; NONEON-NOSVE-NEXT:    str d1, [sp, #24]
; NONEON-NOSVE-NEXT:    ldr w11, [sp, #20]
; NONEON-NOSVE-NEXT:    ldr w10, [sp, #28]
; NONEON-NOSVE-NEXT:    sbfx w8, w8, #0, #1
; NONEON-NOSVE-NEXT:    sbfx w9, w9, #0, #1
...
; NONEON-NOSVE-NEXT:    sub sp, sp, #64
; NONEON-NOSVE-NEXT:    .cfi_def_cfa_offset 64
; NONEON-NOSVE-NEXT:    str d2, [sp, #24]
; NONEON-NOSVE-NEXT:    ldrb w13, [sp, #31]
; NONEON-NOSVE-NEXT:    stp q0, q1, [sp, #32]
; NONEON-NOSVE-NEXT:    ldrb w15, [sp, #30]
; NONEON-NOSVE-NEXT:    ldrh w16, [sp, #62]
; NONEON-NOSVE-NEXT:    ldrh w17, [sp, #46]
; NONEON-NOSVE-NEXT:    ldrb w14, [sp, #29]
; NONEON-NOSVE-NEXT:    sbfx w13, w13, #0, #1
; NONEON-NOSVE-NEXT:    sbfx w15, w15, #0, #1
; NONEON-NOSVE-NEXT:    ldrb w12, [sp, #28]
; NONEON-NOSVE-NEXT:    sbfx w14, w14, #0, #1
...
; NONEON-NOSVE-NEXT:    csel w13, w17, w16, ne
; NONEON-NOSVE-NEXT:    ldrh w16, [sp, #44]
; NONEON-NOSVE-NEXT:    tst w15, #0xffff
; NONEON-NOSVE-NEXT:    strh w13, [sp, #14]
; NONEON-NOSVE-NEXT:    ldrh w13, [sp, #60]
; NONEON-NOSVE-NEXT:    ldrh w15, [sp, #42]
; NONEON-NOSVE-NEXT:    sbfx w11, w11, #0, #1
; NONEON-NOSVE-NEXT:    sbfx w10, w10, #0, #1
; NONEON-NOSVE-NEXT:    sbfx w9, w9, #0, #1
; NONEON-NOSVE-NEXT:    csel w13, w16, w13, ne
...
; NONEON-NOSVE-NEXT:    strh w13, [sp, #12]
...
; NONEON-NOSVE-NEXT:    ldrh w13, [sp, #56]
; NONEON-NOSVE-NEXT:    csel w12, w14, w13, ne
; NONEON-NOSVE-NEXT:    ldrh w13, [sp, #38]
; NONEON-NOSVE-NEXT:    tst w11, #0xffff
; NONEON-NOSVE-NEXT:    strh w12, [sp, #8]
; NONEON-NOSVE-NEXT:    ldrh w12, [sp, #54]
; NONEON-NOSVE-NEXT:    csel w11, w13, w12, ne
; NONEON-NOSVE-NEXT:    ldrh w12, [sp, #36]
; NONEON-NOSVE-NEXT:    tst w10, #0xffff
; NONEON-NOSVE-NEXT:    strh w11, [sp, #6]
; NONEON-NOSVE-NEXT:    ldrh w11, [sp, #52]
; NONEON-NOSVE-NEXT:    csel w10, w12, w11, ne
; NONEON-NOSVE-NEXT:    ldrh w11, [sp, #34]
; NONEON-NOSVE-NEXT:    tst w9, #0xffff
; NONEON-NOSVE-NEXT:    strh w10, [sp, #4]
; NONEON-NOSVE-NEXT:    ldrh w10, [sp, #50]
; NONEON-NOSVE-NEXT:    csel w9, w11, w10, ne
; NONEON-NOSVE-NEXT:    ldrh w10, [sp, #32]
; NONEON-NOSVE-NEXT:    tst w8, #0xffff
; NONEON-NOSVE-NEXT:    strh w9, [sp, #2]
...
; NONEON-NOSVE-NEXT:    stp q0, q1, [sp, #32]
; NONEON-NOSVE-NEXT:    ldrh w11, [sp, #28]
; NONEON-NOSVE-NEXT:    ldr w12, [sp, #60]
; NONEON-NOSVE-NEXT:    ldr w13, [sp, #44]
...
; NONEON-NOSVE-NEXT:    sbfx w8, w8, #0, #1
; NONEON-NOSVE-NEXT:    csel w9, w13, w12, ne
; NONEON-NOSVE-NEXT:    ldr w12, [sp, #40]
; NONEON-NOSVE-NEXT:    cmp w11, #0
; NONEON-NOSVE-NEXT:    str w9, [sp, #12]
; NONEON-NOSVE-NEXT:    ldr w9, [sp, #56]
; NONEON-NOSVE-NEXT:    ldr w11, [sp, #36]
; NONEON-NOSVE-NEXT:    csel w9, w12, w9, ne
; NONEON-NOSVE-NEXT:    cmp w10, #0
; NONEON-NOSVE-NEXT:    ldr w10, [sp, #32]
; NONEON-NOSVE-NEXT:    str w9, [sp, #8]
; NONEON-NOSVE-NEXT:    ldr w9, [sp, #52]
; NONEON-NOSVE-NEXT:    csel w9, w11, w9, ne
; NONEON-NOSVE-NEXT:    cmp w8, #0
; NONEON-NOSVE-NEXT:    str w9, [sp, #4]
...
; NONEON-NOSVE-NEXT:    ldp w10, w13, [sp, #68]
; NONEON-NOSVE-NEXT:    ldp w12, w11, [sp, #88]
; NONEON-NOSVE-NEXT:    ldr w14, [sp, #76]
...
; NONEON-NOSVE-NEXT:    stp w12, w11, [sp, #40]
; NONEON-NOSVE-NEXT:    csel w10, w15, w10, eq
; NONEON-NOSVE-NEXT:    cmp w13, w16
; NONEON-NOSVE-NEXT:    ldr w15, [sp, #64]
...
; NONEON-NOSVE-NEXT:    stp q0, q1, [sp, #32]
; NONEON-NOSVE-NEXT:    ldr x10, [sp, #56]
; NONEON-NOSVE-NEXT:    ldr x11, [sp, #40]
...
; NONEON-NOSVE-NEXT:    ldr x10, [sp, #32]
...
; NONEON-NOSVE-NEXT:    .cfi_def_cfa_offset 96
; NONEON-NOSVE-NEXT:    stp q2, q3, [sp, #64]
; NONEON-NOSVE-NEXT:    ldr x8, [sp, #24]
; NONEON-NOSVE-NEXT:    ldr x9, [sp, #8]
; NONEON-NOSVE-NEXT:    ldp x10, x13, [sp, #64]
; NONEON-NOSVE-NEXT:    ldp x11, x12, [sp, #80]
...
; NONEON-NOSVE-NEXT:    stp x9, x12, [sp, #48]

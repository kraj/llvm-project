...
; CHECK-i64-NEXT:    stp q3, q0, [sp, #16] // 32-byte Folded Spill
; CHECK-i64-NEXT:    mov v0.16b, v1.16b
; CHECK-i64-NEXT:    str x30, [sp, #64] // 8-byte Folded Spill
; CHECK-i64-NEXT:    str q2, [sp, #48] // 16-byte Folded Spill
; CHECK-i64-NEXT:    bl lrintl
; CHECK-i64-NEXT:    fmov d0, x0
; CHECK-i64-NEXT:    str q0, [sp] // 16-byte Folded Spill
...
; CHECK-i64-NEXT:    ldp q0, q4, [sp] // 32-byte Folded Reload
...
; CHECK-i32-NEXT:    stp q3, q5, [sp] // 32-byte Folded Spill
; CHECK-i32-NEXT:    stp q6, q7, [sp, #32] // 32-byte Folded Spill
; CHECK-i32-NEXT:    stp q2, q4, [sp, #80] // 32-byte Folded Spill
...
; CHECK-i64-NEXT:    stp q7, q6, [sp, #32] // 32-byte Folded Spill
; CHECK-i64-NEXT:    stp q5, q4, [sp, #64] // 32-byte Folded Spill
; CHECK-i64-NEXT:    stp q3, q2, [sp, #96] // 32-byte Folded Spill
; CHECK-i64-NEXT:    bl lrintl
; CHECK-i64-NEXT:    fmov d0, x0
; CHECK-i64-NEXT:    str q0, [sp, #16] // 16-byte Folded Spill
; CHECK-i64-NEXT:    ldr q0, [sp] // 16-byte Folded Reload
...
; CHECK-i64-NEXT:    ldp q0, q1, [sp, #16] // 32-byte Folded Reload
; CHECK-i64-NEXT:    ldr q2, [sp, #80] // 16-byte Folded Reload
...
; CHECK-i32-NEXT:    stp q1, q2, [sp, #96] // 32-byte Folded Spill
...
; CHECK-i32-NEXT:    stp q7, q4, [sp, #176] // 32-byte Folded Spill
...
; CHECK-i32-NEXT:    stp q6, q1, [sp, #224] // 32-byte Folded Spill
; CHECK-i32-NEXT:    ldr q1, [sp, #272]
; CHECK-i32-NEXT:    str q1, [sp, #208] // 16-byte Folded Spill
; CHECK-i32-NEXT:    bl lrintl
; CHECK-i32-NEXT:    fmov s0, w0
; CHECK-i32-NEXT:    str q0, [sp, #128] // 16-byte Folded Spill
; CHECK-i32-NEXT:    ldr q0, [sp, #96] // 16-byte Folded Reload
; CHECK-i32-NEXT:    bl lrintl
...
; CHECK-i32-NEXT:    bl lrintl
; CHECK-i32-NEXT:    fmov s0, w0
; CHECK-i32-NEXT:    str q0, [sp, #176] // 16-byte Folded Spill
...
; CHECK-i32-NEXT:    bl lrintl
; CHECK-i32-NEXT:    fmov s0, w0
; CHECK-i32-NEXT:    str q0, [sp, #160] // 16-byte Folded Spill
; CHECK-i32-NEXT:    ldr q0, [sp, #32] // 16-byte Folded Reload
; CHECK-i32-NEXT:    bl lrintl
; CHECK-i32-NEXT:    ldr q0, [sp, #160] // 16-byte Folded Reload
; CHECK-i32-NEXT:    mov v0.s[1], w0
...
; CHECK-i32-NEXT:    bl lrintl
; CHECK-i32-NEXT:    ldp q3, q2, [sp, #160] // 32-byte Folded Reload
; CHECK-i32-NEXT:    ldr q0, [sp, #128] // 16-byte Folded Reload
; CHECK-i32-NEXT:    ldp x29, x30, [sp, #256] // 16-byte Folded Reload
; CHECK-i32-NEXT:    ldr q1, [sp, #192] // 16-byte Folded Reload
...
; CHECK-i64-NEXT:    stp q7, q4, [sp] // 32-byte Folded Spill
; CHECK-i64-NEXT:    stp q6, q3, [sp, #80] // 32-byte Folded Spill
; CHECK-i64-NEXT:    stp q5, q2, [sp, #112] // 32-byte Folded Spill
; CHECK-i64-NEXT:    ldr q2, [sp, #336]
; CHECK-i64-NEXT:    str q2, [sp, #208] // 16-byte Folded Spill
...
; CHECK-i64-NEXT:    ldr q0, [sp, #128] // 16-byte Folded Reload
; CHECK-i64-NEXT:    ldr q2, [sp, #16] // 16-byte Folded Reload
; CHECK-i64-NEXT:    ldp q4, q1, [sp, #224] // 32-byte Folded Reload
; CHECK-i64-NEXT:    ldr q3, [sp, #80] // 16-byte Folded Reload
; CHECK-i64-NEXT:    ldp x29, x30, [sp, #256] // 16-byte Folded Reload
; CHECK-i64-NEXT:    ldr q5, [sp, #176] // 16-byte Folded Reload
; CHECK-i64-NEXT:    mov v7.d[1], v0.d[0]
; CHECK-i64-NEXT:    ldr q0, [sp, #48] // 16-byte Folded Reload
; CHECK-i64-NEXT:    ldr q6, [sp, #208] // 16-byte Folded Reload

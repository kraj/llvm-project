...
; CHECK-GI-NEXT:    mov v1.s[1], v2.s[0]
; CHECK-GI-NEXT:    ldp q2, q3, [sp, #64] // 32-byte Folded Reload
...
; CHECK-GI-NEXT:    str q1, [sp, #176] // 16-byte Folded Spill
...
; CHECK-GI-NEXT:    fmov s0, s1
; CHECK-GI-NEXT:    bl sinf
; CHECK-GI-NEXT:    ldr q1, [sp, #176] // 16-byte Folded Reload
; CHECK-GI-NEXT:    fcvt h0, s0
...
; CHECK-GI-NEXT:    fmov s0, s1
; CHECK-GI-NEXT:    bl sinf
; CHECK-GI-NEXT:    ldr q3, [sp, #224] // 16-byte Folded Reload
; CHECK-GI-NEXT:    ldr q2, [sp, #192] // 16-byte Folded Reload
; CHECK-GI-NEXT:    ldr q1, [sp, #160] // 16-byte Folded Reload
...
; CHECK-GI-NEXT:    ldp q0, q4, [sp, #16] // 32-byte Folded Reload
; CHECK-GI-NEXT:    mov v3.h[6], v4.h[0]
; CHECK-GI-NEXT:    mov v1.h[6], v0.h[0]

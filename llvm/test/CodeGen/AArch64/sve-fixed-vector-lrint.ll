...
; CHECK-i32-NEXT:    stp q2, q1, [sp] // 32-byte Folded Spill
; CHECK-i32-NEXT:    stp q4, q3, [sp, #32] // 32-byte Folded Spill
; CHECK-i32-NEXT:    stp q6, q5, [sp, #64] // 32-byte Folded Spill
; CHECK-i32-NEXT:    bl lrintl
...
; CHECK-i64-NEXT:    stp q6, q1, [sp, #16] // 32-byte Folded Spill
; CHECK-i64-NEXT:    stp q3, q2, [sp, #64] // 32-byte Folded Spill
; CHECK-i64-NEXT:    stp q5, q4, [sp, #96] // 32-byte Folded Spill
; CHECK-i64-NEXT:    bl lrintl
; CHECK-i64-NEXT:    fmov d0, x0
; CHECK-i64-NEXT:    str q0, [sp] // 16-byte Folded Spill
; CHECK-i64-NEXT:    ldr q0, [sp, #16] // 16-byte Folded Reload
...
; CHECK-i32-NEXT:    stp q2, q1, [sp, #144] // 32-byte Folded Spill
; CHECK-i32-NEXT:    ldr q1, [sp, #368]
; CHECK-i32-NEXT:    stp q3, q0, [sp, #208] // 32-byte Folded Spill
...
; CHECK-i32-NEXT:    stp q7, q6, [sp, #112] // 32-byte Folded Spill
; CHECK-i32-NEXT:    mov v0.16b, v1.16b
; CHECK-i32-NEXT:    stp q5, q4, [sp, #176] // 32-byte Folded Spill
; CHECK-i32-NEXT:    bl lrintl
; CHECK-i32-NEXT:    ldr q0, [sp, #32] // 16-byte Folded Reload
; CHECK-i32-NEXT:    str w0, [sp, #268] // 4-byte Folded Spill
; CHECK-i32-NEXT:    bl lrintl
; CHECK-i32-NEXT:    ldr q0, [sp, #16] // 16-byte Folded Reload
; CHECK-i32-NEXT:    str w0, [sp, #32] // 4-byte Folded Spill
; CHECK-i32-NEXT:    bl lrintl
; CHECK-i32-NEXT:    ldr q0, [sp, #48] // 16-byte Folded Reload
...
; CHECK-i32-NEXT:    fmov s0, w0
; CHECK-i32-NEXT:    ldr w8, [sp, #16] // 4-byte Folded Reload
...
; CHECK-i32-NEXT:    mov v3.s[1], w8
; CHECK-i32-NEXT:    ldr w8, [sp, #32] // 4-byte Folded Reload
...
; CHECK-i64-NEXT:    addvl x8, sp, #4
; CHECK-i64-NEXT:    str q0, [sp, #32] // 16-byte Folded Spill
; CHECK-i64-NEXT:    stp q7, q6, [sp, #160] // 32-byte Folded Spill
; CHECK-i64-NEXT:    str q1, [sp, #144] // 16-byte Folded Spill
; CHECK-i64-NEXT:    ldr q1, [x8, #288]
; CHECK-i64-NEXT:    addvl x8, sp, #4
; CHECK-i64-NEXT:    stp q3, q2, [sp, #192] // 32-byte Folded Spill
; CHECK-i64-NEXT:    str q1, [sp, #128] // 16-byte Folded Spill
; CHECK-i64-NEXT:    ldr q1, [x8, #304]
; CHECK-i64-NEXT:    addvl x8, sp, #4
; CHECK-i64-NEXT:    stp q5, q4, [sp, #224] // 32-byte Folded Spill

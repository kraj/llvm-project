...
; NONEON-NOSVE-NEXT:    ldrb w1, [sp, #31]
; NONEON-NOSVE-NEXT:    ldrb w2, [sp, #23]
; NONEON-NOSVE-NEXT:    str d2, [sp]
; NONEON-NOSVE-NEXT:    ldrb w5, [sp, #7]
; NONEON-NOSVE-NEXT:    ldrb w3, [sp, #30]
; NONEON-NOSVE-NEXT:    ldrb w4, [sp, #22]
; NONEON-NOSVE-NEXT:    madd w1, w2, w1, w5
; NONEON-NOSVE-NEXT:    ldrb w18, [sp, #29]
; NONEON-NOSVE-NEXT:    ldrb w0, [sp, #21]
; NONEON-NOSVE-NEXT:    ldrb w16, [sp, #28]
; NONEON-NOSVE-NEXT:    ldrb w17, [sp, #20]
; NONEON-NOSVE-NEXT:    ldrb w14, [sp, #27]
; NONEON-NOSVE-NEXT:    ldrb w15, [sp, #19]
; NONEON-NOSVE-NEXT:    ldrb w12, [sp, #26]
; NONEON-NOSVE-NEXT:    ldrb w13, [sp, #18]
; NONEON-NOSVE-NEXT:    strb w1, [sp, #15]
; NONEON-NOSVE-NEXT:    ldrb w1, [sp, #6]
...
; NONEON-NOSVE-NEXT:    strb w1, [sp, #14]
; NONEON-NOSVE-NEXT:    ldrb w1, [sp, #5]
; NONEON-NOSVE-NEXT:    madd w18, w0, w18, w1
; NONEON-NOSVE-NEXT:    strb w18, [sp, #13]
; NONEON-NOSVE-NEXT:    ldrb w18, [sp, #4]
; NONEON-NOSVE-NEXT:    madd w16, w17, w16, w18
; NONEON-NOSVE-NEXT:    strb w16, [sp, #12]
; NONEON-NOSVE-NEXT:    ldrb w16, [sp, #3]
; NONEON-NOSVE-NEXT:    madd w14, w15, w14, w16
; NONEON-NOSVE-NEXT:    strb w14, [sp, #11]
; NONEON-NOSVE-NEXT:    ldrb w14, [sp, #2]
; NONEON-NOSVE-NEXT:    madd w12, w13, w12, w14
; NONEON-NOSVE-NEXT:    strb w12, [sp, #10]
; NONEON-NOSVE-NEXT:    ldrb w12, [sp, #1]
; NONEON-NOSVE-NEXT:    madd w10, w11, w10, w12
; NONEON-NOSVE-NEXT:    strb w10, [sp, #9]

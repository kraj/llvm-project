...
# Setup config name.
config.name = "InstrumentorExamples-" + config.target_arch
...
# Add path to FLOP counter runtime library
config.substitutions.append(("%flop_counter_lib_dir", config.compiler_rt_libdir))
...
config.substitutions.append(("%instrumentor_config_dir", instrumentor_config_dir))

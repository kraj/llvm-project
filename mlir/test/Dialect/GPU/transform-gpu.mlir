...
// CHECK-DAG: #[[$MAP_LIN_W:.*]] = affine_map<(d0, d1) -> ((d0 + d1 * 73) floordiv 32)>
// CHECK-DAG: #[[$MAP_W0:.*]] = affine_map<(d0) -> (d0 * 32 - (d0 floordiv 2) * 64)>
// CHECK-DAG: #[[$MAP_W1:.*]] = affine_map<(d0) -> ((d0 floordiv 2) * 32)>

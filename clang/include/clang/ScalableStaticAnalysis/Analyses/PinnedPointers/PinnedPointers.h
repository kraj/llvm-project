...
//===----------------------------------------------------------------------===//
//
// Declares data structures for the Pinned Pointers analysis, which identifies
// pointer entities that must retain their pointer type throughout the program.
//
//===----------------------------------------------------------------------===//

#ifndef LLVM_CLANG_SCALABLESTATICANALYSIS_ANALYSES_PINNEDPOINTERS_PINNEDPOINTERS_H
#define LLVM_CLANG_SCALABLESTATICANALYSIS_ANALYSES_PINNEDPOINTERS_PINNEDPOINTERS_H
...
struct PinnedPointersEntitySummary final : public EntitySummary {
  static constexpr llvm::StringLiteral Name = "PinnedPointers";

  static SummaryName summaryName() { return SummaryName(Name.str()); }

  SummaryName getSummaryName() const override { return summaryName(); }

  bool friend operator==(const PinnedPointersEntitySummary &This,
                         const PinnedPointersEntitySummary &Other) {
...
struct PinnedPointersAnalysisResult final : AnalysisResult {
  static constexpr llvm::StringLiteral Name = "PinnedPointersAnalysisResult";
...
#endif // LLVM_CLANG_SCALABLESTATICANALYSIS_ANALYSES_PINNEDPOINTERS_PINNEDPOINTERS_H

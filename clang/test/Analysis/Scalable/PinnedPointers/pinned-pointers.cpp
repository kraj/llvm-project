// End-to-end test of the Pinned Pointers analysis.

// RUN: rm -rf %t && mkdir -p %t

// RUN: %clang_cc1 -fsyntax-only %s \
// RUN:   --ssaf-extract-summaries=PinnedPointers \
...
// RUN:   -a PinnedPointersAnalysisResult
...
// CHECK: "analysis_name": "PinnedPointersAnalysisResult"

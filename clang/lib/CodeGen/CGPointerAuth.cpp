...
llvm::Instruction *CodeGenFunction::EmitArrayPointerAuthRelocationFixup(
  ...
  static const char *BodyNames[] = {"relocation_ptrauth_fixup.body",
                                    "relocation_subarray_ptrauth_fixup.body"};
  static const char *IndexNames[] = {"relocation_ptrauth_fixup.index",
                                     "relocation_subarray_ptrauth_fixup.index"};
  static const char *DstElementNames[] = {
      "relocation_ptrauth_fixup.dstobject",
      "relocation_subarray_ptrauth_fixup.dst"};
  static const char *SrcElementNames[] = {
      "relocation_ptrauth_fixup.srcobject",
      "relocation_subarray_ptrauth_fixup.src"};
  static const char *IncrementNames[] = {
      "relocation_ptrauth_fixup.next_index",
      "relocation_subarray_ptrauth_fixup.next_index"};
  static const char *LoopGuardNames[] = {
      "relocation_ptrauth_fixup.is_complete",
      "relocation_subarray_ptrauth_fixup.is_complete"};
  static const char *LoopEscapeNames[] = {
      "relocation_ptrauth_fixup.end", "relocation_subarray_ptrauth_fixup.end"};
  ...
  llvm::BasicBlock *RelocationFixupBody =
      createBasicBlock(BodyNames[IsSubobject]);
  EmitBlock(RelocationFixupBody);
  llvm::Value *Zero = llvm::ConstantInt::get(SizeTy, 0);
  llvm::PHINode *Index = Builder.CreatePHI(SizeTy, 2, IndexNames[IsSubobject]);
  ...
  llvm::Value *NextIndex =
      Builder.CreateNUWAdd(Index, llvm::ConstantInt::get(Index->getType(), 1),
                           IncrementNames[IsSubobject]);
  Index->addIncoming(NextIndex, Builder.GetInsertBlock());
  llvm::Value *IsComplete =
      Builder.CreateICmpEQ(NextIndex, Count, LoopGuardNames[IsSubobject]);
  llvm::BasicBlock *RelocationFixupFinished =
      createBasicBlock(LoopEscapeNames[IsSubobject]);
